# @diotoborg/ea-consectetur

[![NPM version](https://img.shields.io/npm/v/@diotoborg/ea-consectetur.svg?style=flat)](https://npmjs.org/package/@diotoborg/ea-consectetur)
[![NPM downloads](https://img.shields.io/npm/dm/@diotoborg/ea-consectetur.svg?style=flat)](https://npmjs.org/package/@diotoborg/ea-consectetur)
![CI](https://github.com/diotoborg/ea-consectetur/workflows/CI/badge.svg)
...
```shell
yarn add --dev @diotoborg/ea-consectetur
```

Or

```shell
npm install --save-dev @diotoborg/ea-consectetur
```
...
const eslintPluginEmberRecommended = require('@diotoborg/ea-consectetur/configs/recommended');
...
💼 [Configurations](https://github.com/diotoborg/ea-consectetur#-configurations) enabled in.\
✅ Set in the `recommended` [configuration](https://github.com/diotoborg/ea-consectetur#-configurations).\
![gjs logo](/docs/svgs/gjs.svg) Set in the `recommended-gjs` [configuration](https://github.com/diotoborg/ea-consectetur#-configurations).\
![gts logo](/docs/svgs/gts.svg) Set in the `recommended-gts` [configuration](https://github.com/diotoborg/ea-consectetur#-configurations).\
...
If you have any suggestions, ideas, or problems, feel free to [create an issue](https://github.com/diotoborg/ea-consectetur/issues/new), but first please make sure your question does not repeat [previous ones](https://github.com/diotoborg/ea-consectetur/issues).

### Creating a New Rule

- [Create an issue](https://github.com/diotoborg/ea-consectetur/issues/new) with a description of the proposed rule
- Create files for the [new rule](https://eslint.org/docs/developer-guide/working-with-rules):
  ...
  - `docs/rules/new-rule.md` (documentation, start from the template -- [raw](https://raw.githubusercontent.com/ember-cli/@diotoborg/ea-consectetur/master/docs/rules/_TEMPLATE_.md), [rendered](docs/rules/_TEMPLATE_.md))
